	...
	jQuery("a.ct_tab").toggle( 
				function () {
					jQuery(".ct_form").css('display', 'block'); 
 					jQuery(".ct_container").animate({marginLeft: "0px"},{ duration: 'slow', easing: '<?php echo $effect; ?>'}) 
                }, 
                function () { 
					jQuery(".ct_container").animate({marginLeft: "-300px"},{ duration: 'slow', easing: '<?php echo $effect; ?>'})  
				} 
		); 
